    ...
    <section className="w-[1248px]"> 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 px-10 md:px-32 pt-5 md:pt-16">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-5 md:gap-10 mt-10 md:mt-0">
          <Image src="https://cdn.sanity.io/images/lzplr4pt/production/bfd5b4b468e1a6c84c25589fae1a103cac342102-278x296.png?w=2000&fit=max&auto=format" alt="girl" width={500} height={500} />
